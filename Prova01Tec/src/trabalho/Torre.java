...
public class Torre extends RoboInicial{

	public Torre(int id, String nome, Tabuleiro t1) {
		super(id, nome, t1);
		this.limMovimento = 2;
		this.setIcone('T');
	}
	...
	public boolean andar(int ir) {
		if(tabuleiroRobo.podeMovimentar(posX, posY, 0, ir)&& tabuleiroRobo.limitadorMovimento(ir, limMovimento)) {
	...
	public boolean retroceder(int voltar) {
		if(tabuleiroRobo.podeMovimentar(posX, posY, 0,-voltar)&& tabuleiroRobo.limitadorMovimento(voltar, limMovimento)) {
